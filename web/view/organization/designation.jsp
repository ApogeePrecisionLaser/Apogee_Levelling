       ...
       <div class="container-fluid">
         ...
         <div class="container  topbox">
                                 <h1>Designation</h1>
                                    ...
                                    <form name="form0" class="form-group row boxeffext" method="POST" action="designationCont.do">
...
<!--                  <td align="center"><input class="btn btn-success" type="submit"  name="task" id="active" value="ACTIVE RECORDS"></td>
             ...
             <td>  <select class="ui dropdown form-control" name="task" id="hiera" >
                                                            ...
                                                            <td><input type="submit" class="btn btn-primary" id="hiera" name="search_org" value="SEARCH RECORDS" onclick="setStatus(id)"></td>
                                                               ...
                                                               <DIV class="container">
                                    <form name="form1" method="POST" action="designationCont.do" class="boxeffext">
                                        ...
                                        <form name="form2" method="POST" class="form-group row boxeffext" action="designationCont.do" onsubmit="return verify()">
                                            <table id="table2"  class="table table-bordered table-striped" border="0"  align="center" width="600">
                                               ...
                                               <tr>
                                                    ...
                                                    <th class="heading1" >Designation code</th><td><input class="form-control" type="text" id="designation_code" name="designation_code" value="" size="45" disabled></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th class="heading1" >Description</th><td><input class="form-control" type="text" id="description" name="description" value="" size="45" disabled></td>
                                                </tr>
                                                <tr>
